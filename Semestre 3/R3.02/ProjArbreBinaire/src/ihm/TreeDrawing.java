...
class TreeDrawing<E extends Comparable<E>, T> extends Canvas {
	...
	ArbreBinaire<E, T>.Noeud myTree;
	static final int RADIUS = 10;

	TreeDrawing(ArbreBinaire<E, T>.Noeud node){
	...
	public void drawSubtree(Graphics g,ArbreBinaire<E, T>.Noeud tree, int x, int width,int level){
